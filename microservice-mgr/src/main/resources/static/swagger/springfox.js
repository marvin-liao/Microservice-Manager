$(function() {
  var springfox = {
    "baseUrl": function() {
      var urlMatches = /(.*)\/detail.html.*/.exec(window.location.href);
      return urlMatches[1];
    },
    "securityConfig": function(cb) {
      cb({"apiKeyVehicle":"header","scopeSeparator":",","apiKeyName":"api_key"});
      /*$.getJSON(this.baseUrl() + "/swagger-resources/configuration/security", function(data) {
        cb(data);
      });*/
    },
    "uiConfig": function(cb) {
      cb({"validatorUrl":null,"docExpansion":"none","apisSorter":"alpha","defaultModelRendering":"schema","requestTimeout":null,"supportedSubmitMethods":["get","post","put","delete","patch"],"jsonEditor":false,"showRequestHeaders":true});
  ...
  window.oAuthRedirectUrl = springfox.baseUrl() + '/swagger/o2c.html';
  ...
  function initializeBaseUrl() {
    ...
    title = "/doc/" + window.location.hash.replace("#", "");
    data = [{"name":"default","location":title,"swaggerVersion":"2.0"}];
